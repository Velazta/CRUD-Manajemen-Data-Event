...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <a href="index.php?controller=Event&action=create" class="inline-block rounded bg-green-600 px-5 py-2 text-white font-medium hover:bg-green-700 transition duration-200 mt-4 sm:mt-0">+ Tambah Event</a>
    </div>
   ...
   <form method="GET" action="index.php" class="mb-4">
    ...
    <input name="search" type="text" placeholder="Cari nama event..."
            ...
            <tbody id="eventTableBody" class="divide-y divide-gray-200">
                <?php if (!empty($events) && is_array($events)): ?>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-4 px-6 whitespace-nowrap text-sm text-gray-700"><?= htmlspecialchars($event['date']) ?></td>
                        ...
                        <td class="py-4 px-6 whitespace-nowrap text-center text-sm font-medium space-x-2">
                            ...
                            <a href="index.php?controller=Event&action=delete&id=<?= $event['id'] ?>" class="text-red-600 hover:text-red-800 font-semibold" onclick="return confirm('Hapus event ini?')">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="5" class="text-center p-4">Data event tidak ditemukan.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
